  ...
  <header>
    ...
    <div class="jumbotron-section">
      <div class="container head-page">
        <div class="row">
          <div class="col-xs-12">
            <div class="head text-center">การยืนยันพบการผิดพลาด</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-10 col-sm-offset-1">
          <h2 class="text-center header">การยืนยันพบการผิดพลาด</h2>
          <h4 class="text-center subHead">พบการผิดพลาดในการยืนยันตัวตนกรุณาเช็คลิงค์ที่ที่ได้รับอีกครั้ง</h4>
        </div>
      </div>
    </div>
  </section>
